...
@implementation DSPF_TourTableViewCell
...
- (void)setTourDeparture:(Departure *)newDeparture {
    ...
    if ([self.tourDeparture.canceled boolValue]) { 
        ...
        if (todaysTourException &&
            ...
            } else if (PFTourTypeSupported(@"1X1", nil) && self.tourDeparture.location_id.code && self.tourDeparture.location_id.code.length > 0) {
